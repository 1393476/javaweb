...
<body>
	...
	<%--
	FileWriter output_path = new FileWriter("/home/wangning/tmppath.txt");
		System.out.println(request.getParameter("path")+"--------------------path33333");
		output_path.write(request.getParameter("path"));
		output_path.close();
	...
	<script>
		...
		btn_next.onclick = function() {
			...
			$.post('/Servlet_study/nextServlet', {"user":"<%=session.getAttribute("username")%>"},
